    ...
    useEffect(() => {
        ...
        firebase.db.collection('foods')
            ...
            .onSnapshot(querySnapshot => {
                ...
                setFood(food);
                //Data parameter
                var newData = food.filter(l => l.name.toLowerCase().match(props.route.params.nameFood));
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                <TouchableOpacity onPress={() => props.navigation.goBack()}>
                    <FontAwesome style={{ paddingHorizontal: 10 }} name='chevron-circle-left' size={28} color='black' />
                </TouchableOpacity>
                <TextInput
                ...
                <TouchableOpacity onPress={() => _search()}>
                    <FontAwesome style={{ paddingHorizontal: 10 }} name='search' size={28} color='black' />
                </TouchableOpacity>
            </View>
